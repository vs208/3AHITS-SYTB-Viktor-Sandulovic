...
### grep
Das Tool `grep` sucht in Dateien nach bestimmten Textmustern. Mit der Option `-E` aktiviert man **ERE** (Extended Regular Expressions).Damit Zeichen wie `+` oder `?` ohne Backslash richtig funktiornieren.
